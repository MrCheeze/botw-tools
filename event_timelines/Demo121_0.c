-------- Event timeline: Demo121_0 --------
actors: 11
clips: 45
oneshots: 0
cuts: 7
duration: 1580.0
subtimelines: ['Demo121_0_effect']
...
[      0.0] E DgnObj_RemainsClearTerminalBody_A_01[0] - Demo_PlayASForTimeline (#28, xc=0)
               ...
               {ASName: Standby, ClothWarpMode: 1, IsEnabledAnimeDriven: -1, IsIgnoreSame: false, IsWaitFinish: true,
                 MorphingFrame: 0.0, SeqBank: 0, TargetIndex: -1}
[      0.0] E Enemy_SiteBoss_Spear[0] - Demo_PlayASForTimeline (#40, xc=0)
               duration: 240.0
               {ASName: Demo121_0-C01-SiteBoss_Spear-A-0, ClothWarpMode: 1, IsEnabledAnimeDriven: -1, IsIgnoreSame: false,
                 IsWaitFinish: true, MorphingFrame: 0.0, SeqBank: 0, TargetIndex: -1}
[      0.0] E Enemy_SiteBoss_Spear[0] - Demo_PlayASForTimeline (#44, xc=1)
               duration: 695.0
...
[    240.0] L Enemy_SiteBoss_Spear[0] - Demo_PlayASForTimeline (#40, xc=0)
...
[    240.0] E Enemy_SiteBoss_Spear[0] - Demo_PlayASForTimeline (#41, xc=0)
               duration: 150.0
...
[    390.0] L Enemy_SiteBoss_Spear[0] - Demo_PlayASForTimeline (#41, xc=0)
...
[    390.0] E Enemy_SiteBoss_Spear[0] - Demo_PlayASForTimeline (#42, xc=0)
               duration: 270.0
               {ASName: C03-SiteBoss_Spear-A-0, ClothWarpMode: 1, IsEnabledAnimeDriven: -1, IsIgnoreSame: false,
                 IsWaitFinish: true, MorphingFrame: 0.0, SeqBank: 0, TargetIndex: -1}
[    410.0] E EventControllerRumble[0] - Demo_RumbleSmall (#29, xc=0)
               duration: 180.0
               {Count: 62, IsWaitFinish: true}
[    590.0] L EventControllerRumble[0] - Demo_RumbleSmall (#29, xc=0)
[    590.0] E EventControllerRumble[0] - Demo_RumbleLarge (#30, xc=0)
               duration: 138.0
...
[    660.0] L Enemy_SiteBoss_Spear[0] - Demo_PlayASForTimeline (#42, xc=0)
...
[    660.0] E Enemy_SiteBoss_Spear[0] - Demo_PlayASForTimeline (#43, xc=0)
               duration: 35.0
...
[    690.0] E Fader[0] - Demo_FadeOut (#1, xc=0)
               duration: 120.0
               {Color: 0, DispMode: Auto, Frame: 0, IsWaitFinish: true}
[    695.0] L Enemy_SiteBoss_Spear[0] - Demo_PlayASForTimeline (#43, xc=0)
[    695.0] L Enemy_SiteBoss_Spear[0] - Demo_PlayASForTimeline (#44, xc=1)
[    728.0] L EventControllerRumble[0] - Demo_RumbleLarge (#30, xc=0)
...
[   1200.0] E Obj_HeartUtuwa_A_01[0] - Demo_PlayASForTimeline (#38, xc=0)
               duration: 210.0
               {ASName: C06-Item_HeartUtuwa-A-0, ClothWarpMode: 1, IsEnabledAnimeDriven: -1, IsIgnoreSame: false,
                 IsWaitFinish: true, MorphingFrame: 0.0, SeqBank: 0, TargetIndex: -1}
[   1307.0] E GameROMPlayer[0] - Demo_EmitEquipmentNoise (#32, xc=1)
               duration: 1.0
               {IsWaitFinish: true, Speed: Dash, SteppingFoot: Right}
[   1308.0] L GameROMPlayer[0] - Demo_EmitEquipmentNoise (#32, xc=1)
[   1325.0] E GameROMPlayer[0] - Demo_EmitEquipmentNoise (#33, xc=1)
               duration: 1.0
               {IsWaitFinish: true, Speed: Dash, SteppingFoot: Left}
[   1326.0] L GameROMPlayer[0] - Demo_EmitEquipmentNoise (#33, xc=1)
[   1342.0] E GameROMPlayer[0] - Demo_EmitEquipmentNoise (#34, xc=1)
               duration: 1.0
               {IsWaitFinish: true, Speed: Dash, SteppingFoot: Right}
[   1343.0] L GameROMPlayer[0] - Demo_EmitEquipmentNoise (#34, xc=1)
[   1360.0] E GameROMPlayer[0] - Demo_EmitEquipmentNoise (#35, xc=1)
               duration: 1.0
               {IsWaitFinish: true, Speed: Dash, SteppingFoot: Left}
[   1361.0] L GameROMPlayer[0] - Demo_EmitEquipmentNoise (#35, xc=1)
[   1378.0] E GameROMPlayer[0] - Demo_EmitEquipmentNoise (#36, xc=1)
               duration: 1.0
               {IsWaitFinish: true, Speed: Dash, SteppingFoot: Right}
[   1379.0] L GameROMPlayer[0] - Demo_EmitEquipmentNoise (#36, xc=1)
[   1398.0] E GameROMPlayer[0] - Demo_EmitEquipmentNoise (#37, xc=1)
               duration: 1.0
               {IsWaitFinish: true, Speed: Dash, SteppingFoot: Left}
[   1399.0] L GameROMPlayer[0] - Demo_EmitEquipmentNoise (#37, xc=1)
...
[   1410.0] L Obj_HeartUtuwa_A_01[0] - Demo_PlayASForTimeline (#38, xc=0)
...
[   1410.0] E GameROMPlayer[0] - Demo_PlayASForTimeline (#31, xc=0)
               duration: 170.0
               {ASName: C07-Link-A-0, ClothWarpMode: 1, IsEnabledAnimeDriven: -1, IsIgnoreSame: false, IsWaitFinish: true,
                 MorphingFrame: 0.0, SeqBank: 0, TargetIndex: -1}
[   1410.0] E Obj_HeartUtuwa_A_01[0] - Demo_PlayASForTimeline (#39, xc=0)
               duration: 170.0
...
[   1580.0] L GameROMPlayer[0] - Demo_PlayASForTimeline (#31, xc=0)
[   1580.0] L Obj_HeartUtuwa_A_01[0] - Demo_PlayASForTimeline (#39, xc=0)
