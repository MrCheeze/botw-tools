-------- Event timeline: Demo141_3 --------
actors: 9
clips: 14
oneshots: 0
cuts: 1
duration: 400.0
subtimelines: ['Demo141_3_effect']
...
[      0.0] E Enemy_SiteBoss_Spear_Castle[0] - Demo_PlayASForTimeline (#0, xc=0)
               duration: 400.0
               {ASName: Demo141_3-C02-SiteBoss_Spear-A-0, ClothWarpMode: 1, IsEnabledAnimeDriven: -1, IsIgnoreSame: false,
                 IsWaitFinish: true, MorphingFrame: 0.0, SeqBank: 0, TargetIndex: 0}
[      0.0] E Enemy_SiteBoss_Spear_Castle[0] - Demo_PlayASForTimeline (#1, xc=1)
               duration: 400.0
...
[    114.0] E EventControllerRumble[0] - Demo_RumbleMiddle (#12, xc=0)
               duration: 223.0
               {Count: 10, IsWaitFinish: true}
[    120.0] L GameRomCamera[0] - Demo_FocusDistSetting (#9, xc=1)
[    120.0] E GameRomCamera[0] - Demo_FocusDistSetting (#10, xc=1)
               duration: 10.0
               {FocusDistEnd: 1.7000000476837158, FocusDistStart: 3.0, IsWaitFinish: true}
[    130.0] L GameRomCamera[0] - Demo_FocusDistSetting (#10, xc=1)
[    130.0] E GameRomCamera[0] - Demo_FocusDistSetting (#11, xc=1)
               duration: 270.0
               {FocusDistEnd: 2.200000047683716, FocusDistStart: 1.7000000476837158, IsWaitFinish: true}
[    150.0] E EventSystemActor[0] - Demo_PlayUiActorName (#2, xc=0)
               duration: 180.0
               {ActorName: Enemy_SiteBoss_Spear_Castle, ActorType: 0, IsWaitFinish: true}
[    330.0] L EventSystemActor[0] - Demo_PlayUiActorName (#2, xc=0)
[    337.0] L EventControllerRumble[0] - Demo_RumbleMiddle (#12, xc=0)
[    400.0] L Enemy_SiteBoss_Spear_Castle[0] - Demo_PlayASForTimeline (#0, xc=0)
[    400.0] L Enemy_SiteBoss_Spear_Castle[0] - Demo_PlayASForTimeline (#1, xc=1)
