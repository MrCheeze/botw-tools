...
void Finish_Npc_oasis003_Talk() {
    ...
    && EventSystemActor.CheckFlag({'FlagName': 'GerudoMiniJewel_Finished'})
    && EventSystemActor.CheckFlag({'FlagName': 'Gerudo_Ch_SandWarm_Finish'})
    && EventSystemActor.CheckFlag({'FlagName': 'Gerudo_Ch_FindingValetta_Finish'}) {
