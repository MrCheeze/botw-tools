...
void Demo202_2() {
    ...
    fork {
        ...
        GameROMPlayer.Demo_XLinkEventCreate({'IsWaitFinish': True, 'ELinkKey': 'Demo202_2_Warp', 'SLinkKey': 'Demo_WarpOut_ArrivalEndurance', 'IsTargetDemoSLinkUser': True})
        ...
        if EventSystemActor.CheckFlag({'FlagName': 'FirstTry_100enemy_Middle'}) {
    ...
    if EventSystemActor.CheckFlag({'FlagName': 'FirstTry_100enemy_Middle'}) {
        ...
        fork {
            ...
            GameRomCamera.Demo_MovePosFlow({'Pattern1AtX': 0.0, 'Pattern1AtZ': 0.0, 'Pattern1Fovy': 50.00001907348633, 'TargetActor1': 3, 'AtAppendMode': 2, 'PosAppendMode': 2, 'ActorName1': 'GameROMPlayer', 'Pattern1PosX': 0.0, 'Pattern1PosY': 1.2999999523162842, 'Pattern1PosZ': -3.299999952316284, 'Pattern1AtY': 2.25, 'Count': 240.0, 'IsWaitFinish': False, 'UniqueName1': '', 'TargetActor2': -1, 'ActorName2': '', 'UniqueName2': '', 'GameDataVec3fCameraPos': '', 'GameDataVec3fCameraAt': '', 'FovyAppendMode': 1, 'StartCalcOnly': False, 'MotionMode': 0, 'Cushion': 0.0, 'CollisionInterpolateSkip': True, 'Accept1FrameDelay': False, 'ReviseModeEnd': 1, 'LatShiftRange': 0.0, 'LngShiftRange': 0.0, 'ActorIgnoringCollision': -1})
        }
        ...
        fork {
            ...
            EventSystemActor.Demo_OpenDungeonMessage({'IsWaitFinish': True, 'MessageId': 'DemoMsg/Demo202_2:Demo202_2_Text000'})
        }


        fork {
            EventSystemActor[player].Demo_WaitFrame({'IsWaitFinish': True, 'Frame': 95})
            GameROMPlayer.Demo_PlayASAdapt({'IsWaitFinish': False, 'TargetIndex': -1, 'SeqBank': 0, 'IsIgnoreSame': False, 'IsEnabledAnimeDriven': -1, 'IsOneTimeEndKeep': True, 'NoErrorCheck': True, 'ClothWarpMode': -2, 'MorphingFrame': -1.0, 'ASName': 'Demo202_2-C01-Link-A-0_Loop'})
        } {
            ...
            EventSystemActor.Demo_OpenDungeonMessage({'MessageId': 'DemoMsg/Demo202_2:Demo202_2_Text001', 'IsWaitFinish': True})
        }
        ...
        fork {
            ...
            EventSystemActor.Demo_OpenDungeonMessage({'IsWaitFinish': True, 'MessageId': 'DemoMsg/Demo202_2:Demo202_2_Text002'})
        }


        fork {
            GameRomCamera.Demo_CameraAnimFlow({'SceneName': 'C02-0', 'IsWaitFinish': False, 'CameraName': '', 'StartFrame': 0.0, 'EndFrame': -1.0, 'DOFUse': False, 'DOFStartFrame': 0.0, 'FocalLength': 0.0, 'Aperture': 0.0, 'DOFBlurStart': 2.0, 'DOFEndFrame': 0.0, 'FocalLengthEnd': 0.0, 'ApertureEnd': 0.0, 'DOFBlurEnd': 2.0, 'OverwriteAt': False, 'OverwriteAtDist': 1.0, 'InterpolateCount': 0.0, 'BgCheck': False, 'TargetActor': 1, 'UniqueName': '', 'TargetActorPosReferenceMode': 1, 'TargetActorDirReferenceMode': 0, 'Accept1FrameDelay': False, 'ActorName': ''})
        } {
            EventSystemActor[ms01].Demo_OpenDungeonMessage({'IsWaitFinish': True, 'MessageId': 'DemoMsg/Demo202_2:Demo202_2_Text004'})
        ...
        fork {
            ...
            fork {
                ...
                EventSystemActor[ms01].Demo_OpenDungeonMessage({'IsWaitFinish': True, 'MessageId': 'DemoMsg/Demo202_2:Demo202_2_Text006'})
            }
        ...
        EventSystemActor.Demo_FlagON({'IsWaitFinish': True, 'FlagName': 'FirstTry_100enemy_Middle'})
