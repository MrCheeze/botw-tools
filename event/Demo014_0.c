...
Actor: Enemy_Assassin_Shooter_Azito_Junior[Aoc_Archer1]
entrypoint: None()
actions: ['Demo_ResetBoneCtrl']
queries: []
params: {'CreateMode': 0, 'IsGrounding': False, 'IsWorld': False, 'PosX': 0.0, 'PosY': 0.0, 'PosZ': 0.0, 'RotX': 0.0, 'RotY': 0.0, 'RotZ': 0.0}

Actor: Enemy_Assassin_Shooter_Azito_Junior[Aoc_Archer2]
entrypoint: None()
actions: ['Demo_ResetBoneCtrl']
queries: []
params: {'CreateMode': 0, 'IsGrounding': False, 'IsWorld': False, 'PosX': 0.0, 'PosY': 0.0, 'PosZ': 0.0, 'RotX': 0.0, 'RotY': 0.0, 'RotZ': 0.0}

Actor: BasicSignalTag[Aoc_BasicSignal]
entrypoint: None()
actions: ['Demo_SendSignal']
queries: []
params: {'CreateMode': 2, 'IsGrounding': False, 'IsWorld': False, 'PosX': 0.0, 'PosY': 0.0, 'PosZ': 0.0, 'RotX': 0.0, 'RotY': 0.0, 'RotZ': 0.0}

Actor: Enemy_Assassin_Azito_Middle_DLC2[Aoc_Patroller1]
entrypoint: None()
actions: []
queries: []
params: {'CreateMode': 0, 'IsGrounding': False, 'IsWorld': False, 'PosX': 0.0, 'PosY': 0.0, 'PosZ': 0.0, 'RotX': 0.0, 'RotY': 0.0, 'RotZ': 0.0}

Actor: Enemy_Assassin_Azito_Middle_DLC2[Aoc_Patroller2]
entrypoint: None()
actions: []
queries: []
params: {'CreateMode': 0, 'IsGrounding': False, 'IsWorld': False, 'PosX': 0.0, 'PosY': 0.0, 'PosZ': 0.0, 'RotX': 0.0, 'RotY': 0.0, 'RotZ': 0.0}

Actor: Enemy_Assassin_Azito_Middle_DLC2[Aoc_Patroller3]
entrypoint: None()
actions: []
queries: []
params: {'CreateMode': 0, 'IsGrounding': False, 'IsWorld': False, 'PosX': 0.0, 'PosY': 0.0, 'PosZ': 0.0, 'RotX': 0.0, 'RotY': 0.0, 'RotZ': 0.0}

Actor: Enemy_Assassin_Azito_Middle_DLC2[Aoc_Patroller4]
entrypoint: None()
actions: []
queries: []
params: {'CreateMode': 0, 'IsGrounding': False, 'IsWorld': False, 'PosX': 0.0, 'PosY': 0.0, 'PosZ': 0.0, 'RotX': 0.0, 'RotY': 0.0, 'RotZ': 0.0}

Actor: Enemy_Assassin_Azito_Middle_DLC2[Aoc_Patroller5]
entrypoint: None()
actions: []
queries: []
params: {'CreateMode': 0, 'IsGrounding': False, 'IsWorld': False, 'PosX': 0.0, 'PosY': 0.0, 'PosZ': 0.0, 'RotX': 0.0, 'RotY': 0.0, 'RotZ': 0.0}
...
Actor: Enemy_Assassin_Azito_Middle_DLC2[EntryPoint2(Arg_actor)]
entrypoint: EntryPoint2(Arg_actor)
actions: []
queries: []
params: None

Actor: Enemy_Assassin_Azito_Middle_DLC2[Aoc_C01(Enemy_Assassin_Azito_Middle)]
entrypoint: Aoc_C01(Enemy_Assassin_Azito_Middle)
actions: ['Demo_Notify', 'Demo_PlayASForDemo']
queries: []
params: None

Actor: Enemy_Assassin_Azito_Middle_DLC2[Aoc_DrawSword(Arg_actor)]
entrypoint: Aoc_DrawSword(Arg_actor)
actions: ['Demo_DropWeapon', 'Demo_WeaponDrawn', 'Demo_PlayASForDemo']
queries: []
params: None
...
void EntryPoint2() {
    ...
    call Aoc_C01({'Enemy_Assassin_Azito_Middle': 'Arg_actor', 'Arg_Patroller_UniqueName1': 'Arg_Patroller_UniqueName'})


    fork {

        call Aoc_DrawSword({'Arg_actor': 'Arg_actor'})

    } {

        call Aoc_C02({'Arg_TargetUniqueName': 'Arg_Focus_Door_UniqueName'})


        call Aoc_C03_1({'Arg_TargetUniqueName': 'Arg_Focus_Door_UniqueName'})
...
void Aoc_C03_1() {
    ...
    fork {
        ...
        BasicSignalTag[Aoc_BasicSignal].Demo_SendSignal({'SignalType': 0, 'Value': True, 'IsWaitFinish': False})

        fork {
            Enemy_Assassin_Shooter_Azito_Junior[Aoc_Archer1].Demo_ResetBoneCtrl({'IsWaitFinish': False, 'ResetTarget': 1})
        } {
            Enemy_Assassin_Shooter_Azito_Junior[Aoc_Archer2].Demo_ResetBoneCtrl({'IsWaitFinish': False, 'ResetTarget': 1})
        }
...
void Aoc_Notice_1() {
    ...
    call EntryPoint2({'Arg_Patroller_UniqueName': 'Aoc_Patroller1', 'Arg_Focus_Assassin_Shooter_UniqueName': 'Aoc_Assassin_Shooter_1', 'Arg_Focus_Door_UniqueName': 'Aoc_Door_1', 'Arg_actor': ActorIdentifier(name="Enemy_Assassin_Azito_Middle_DLC2", sub_name="Aoc_Patroller1")})

}

void Aoc_Notice_2() {

    call EntryPoint2({'Arg_Focus_Door_UniqueName': 'Aoc_Door_1', 'Arg_Focus_Assassin_Shooter_UniqueName': 'Aoc_Assassin_Shooter_1', 'Arg_Patroller_UniqueName': 'Aoc_Patroller2', 'Arg_actor': ActorIdentifier(name="Enemy_Assassin_Azito_Middle_DLC2", sub_name="Aoc_Patroller2")})

}

void Aoc_Notice_3() {

    call EntryPoint2({'Arg_Focus_Door_UniqueName': 'Aoc_Door_1', 'Arg_Focus_Assassin_Shooter_UniqueName': 'Aoc_Assassin_Shooter_1', 'Arg_Patroller_UniqueName': 'Aoc_Patroller3', 'Arg_actor': ActorIdentifier(name="Enemy_Assassin_Azito_Middle_DLC2", sub_name="Aoc_Patroller3")})

}

void Aoc_Notice_4() {

    call EntryPoint2({'Arg_Focus_Door_UniqueName': 'Aoc_Door_1', 'Arg_Focus_Assassin_Shooter_UniqueName': 'Aoc_Assassin_Shooter_1', 'Arg_Patroller_UniqueName': 'Aoc_Patroller4', 'Arg_actor': ActorIdentifier(name="Enemy_Assassin_Azito_Middle_DLC2", sub_name="Aoc_Patroller4")})

}

void Aoc_Notice_5() {

    call EntryPoint2({'Arg_Focus_Door_UniqueName': 'Aoc_Door_1', 'Arg_Focus_Assassin_Shooter_UniqueName': 'Aoc_Assassin_Shooter_1', 'Arg_Patroller_UniqueName': 'Aoc_Patroller5', 'Arg_actor': ActorIdentifier(name="Enemy_Assassin_Azito_Middle_DLC2", sub_name="Aoc_Patroller5")})
...
void Aoc_C01() {
    ...
    fork {
        EventSystemActor.Demo_WaitFrame({'IsWaitFinish': True, 'Frame': 5})
        Enemy_Assassin_Azito_Middle_DLC2[Aoc_C01(Enemy_Assassin_Azito_Middle)].Demo_Notify({'IsWaitFinish': True})

        fork {
            EventSystemActor.Demo_WaitFrame({'IsWaitFinish': True, 'Frame': 45})
        } {
            Enemy_Assassin_Azito_Middle_DLC2[Aoc_C01(Enemy_Assassin_Azito_Middle)].Demo_PlayASForDemo({'TargetIndex': -1, 'SeqBank': 0, 'IsIgnoreSame': False, 'IsEnabledAnimeDriven': -1, 'MorphingFrame': -1.0, 'ASName': 'Demo014_0-C01-Assassin_Leader', 'IsWaitFinish': False, 'ClothWarpMode': -2})
        }

    } {
        GameRomCamera.Demo_CameraAnimFlow({'IsWaitFinish': False, 'Accept1FrameDelay': True, 'TargetActor': 3, 'TargetActorPosReferenceMode': 2, 'SceneName': 'C01-1', 'CameraName': '', 'StartFrame': 0.0, 'EndFrame': -1.0, 'DOFUse': False, 'DOFStartFrame': 0.0, 'FocalLength': 0.0, 'Aperture': 0.0, 'DOFBlurStart': 2.0, 'DOFEndFrame': 0.0, 'FocalLengthEnd': 0.0, 'ApertureEnd': 0.0, 'DOFBlurEnd': 2.0, 'InterpolateCount': 0.0, 'BgCheck': False, 'TargetActorDirReferenceMode': 2, 'OverwriteAt': False, 'OverwriteAtDist': 1.0, 'UniqueName': 'Arg_Patroller_UniqueName1', 'ActorName': 'Enemy_Assassin_Azito_Middle_DLC2'})
    }
...
void Aoc_DrawSword() {
    Enemy_Assassin_Azito_Middle_DLC2[Aoc_DrawSword(Arg_actor)].Demo_DropWeapon({'IsWaitFinish': True})
    Enemy_Assassin_Azito_Middle_DLC2[Aoc_DrawSword(Arg_actor)].Demo_WeaponDrawn({'IsWaitFinish': True})
    Enemy_Assassin_Azito_Middle_DLC2[Aoc_DrawSword(Arg_actor)].Demo_PlayASForDemo({'IsWaitFinish': False, 'TargetIndex': -1, 'SeqBank': 0, 'IsIgnoreSame': False, 'IsEnabledAnimeDriven': -1, 'MorphingFrame': -1.0, 'ASName': 'BattleWait', 'ClothWarpMode': -2})
}
