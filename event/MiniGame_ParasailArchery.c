...
queries: ['GeneralChoice2', 'CheckFlag', 'GeneralChoice3', 'CheckGameDataInt', 'CheckMiniGameTimeOver', 'HasPorchItemByCategory', 'HasPorchArrow', 'CheckExistArrow', 'RandomChoice4', 'GeneralChoice4']
