...
void EntryPoint0() {
    if !EventSystemActor.CheckFlag({'FlagName': 'Solitary_Maze_Activated'}) {
        ...
        EventSystemActor.Demo_OpenDungeonMessage({'IsWaitFinish': True, 'MessageId': 'EventFlowMsg/Solitary_Maze:talk00'})
        EventSystemActor.Demo_FlagON({'IsWaitFinish': True, 'FlagName': 'Solitary_Maze_Activated'})
    }
}
