...
void EntryPoint0() {
    if !EventSystemActor.CheckFlag({'FlagName': 'Desert_Maze_Activated'}) {
        ...
        EventSystemActor.Demo_OpenDungeonMessage({'IsWaitFinish': True, 'MessageId': 'EventFlowMsg/Desert_Maze:talk00'})
        EventSystemActor.Demo_FlagON({'IsWaitFinish': True, 'FlagName': 'Desert_Maze_Activated'})
    }
}
