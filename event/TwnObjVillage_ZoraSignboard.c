-------- EventFlow: TwnObjVillage_ZoraSignboard --------
...
void Talk() {
    ...
    call Cam_ZoraSignboard()

    Starter.Demo_OpenMessageDialogOfUnique({'IsWaitFinish': True, 'MstxtName': 'TwnObjVillage_ZoraSignboard'})
}
