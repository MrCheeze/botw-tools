    ...
    if EventSystemActor.CheckFlag({'FlagName': 'Npc_SmallOasis008_Talk'}) {
        if EventSystemActor.CheckFlag({'FlagName': 'Npc_SmallOasis008_Fisrt_boy'}) {
            ...
            if !EventSystemActor.GeneralChoice2() {
                ...
                && EventSystemActor.HasPorchItem({'PorchItemName': 'Armor_053_Head', 'Count': 1})
                && EventSystemActor.HasPorchItem({'Count': 1, 'PorchItemName': 'Armor_053_Upper'}) {
...
void buy() {
    ...
    && EventSystemActor.CheckAddPorchItem({'Count': 1, 'PorchItemName': 'Armor_053_Head'})
    && EventSystemActor.CheckAddPorchItem({'Count': 1, 'PorchItemName': 'Armor_053_Lower'}) {
          ...
          case 0:
            ...
            if !EventSystemActor.GeneralChoice2() {
                if EventSystemActor.CheckRupee({'Value': 200}) {
                    ...
                    && EventSystemActor.CheckAddPorchItem({'Count': 1, 'PorchItemName': 'Armor_053_Lower'})
                    && EventSystemActor.CheckAddPorchItem({'PorchItemName': 'Armor_053_Upper', 'Count': 1}) {
